...
Framework mappings are defined in `controls/registry.json`, which contains 151 control entries. Each entry specifies the check ID, description, and mappings to all applicable frameworks.
